...
import com.android.mobile.games.app.ui.screens.AuthScreen
...
fun AppNavigation() {
    ...
    NavHost(
            ...
            val authViewModel: AuthViewModel = viewModel(
                factory = object : androidx.lifecycle.ViewModelProvider.Factory {
                    override fun <T : androidx.lifecycle.ViewModel> create(modelClass: Class<T>): T {
                        ...
                        return AuthViewModel(identityManager) as T
                    }
                }
            )
            AuthScreen(
                ...
                onNavigateToMain = {
                    navController.navigate(AppRoute.MainMenu.route) {
            ...
            FruitNinjaMenuScreen(
                onStartGameClick = { difficulty ->
                    navController.navigate(
                        AppRoute.FruitNinjaGame.createRoute(difficulty = difficulty.name)
                    )
                },
                onBackClick = {
                    navController.popBackStack()
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(DIFFICULTY_ARGUMENT) { type = NavType.StringType }
            )
        ) { backStackEntry ->
